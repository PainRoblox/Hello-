...
v225:AddParagraph({
    ["Title"] = "Script made by NoM TV",
    ["Content"] = "Thank for use script"
})
v225:AddButton({
    ["Title"] = "Youtube Channel | @NoMTV_Roblox",
    ["Description"] = "Click to Copy",
    ["Callback"] = function()
        setclipboard("https://www.youtube.com/@NoMTV_Roblox/")
    end
})
v225:AddButton({
...
v227["2"].Image = "rbxassetid://99087326771580"
